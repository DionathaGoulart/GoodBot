...
/**
 * Uma ou mais guilds, separadas por vírgula. Aceita `GUILD_IDS` e o `GUILD_ID`
 * singular, igual ao bot: as variáveis do painel vivem na Vercel e as do bot na
 * VM, e os dois lados precisam entender o mesmo formato.
 */
