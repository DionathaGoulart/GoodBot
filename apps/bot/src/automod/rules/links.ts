...
const FILE_EXTENSIONS = new Set([
  'bat', 'bmp', 'css', 'csv', 'doc', 'docx', 'exe', 'gif', 'gz', 'html', 'jpeg', 'jpg', 'js',
  'json', 'log', 'md', 'mov', 'mp3', 'mp4', 'pdf', 'png', 'ppt', 'pptx', 'psd', 'py', 'rar',
  'sh', 'sql', 'svg', 'ts', 'txt', 'wav', 'webp', 'xls', 'xlsx', 'xml', 'yaml', 'yml', 'zip',
]);
