 ...
 * confirma que o squad joga; o voice reservado que esvazia depois do início
 * libera a reserva antes do fim da faixa. Mute, deafen e stream não mudam de
 * canal e ficam de fora, e só voice do pool chega a consultar o banco.
 */
